                            ...
                            <form action="<?= \yii\helpers\Url::to(['index']) ?>" method="get">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="username"
                                           value="<?= Yii::$app->request->get('username'); ?>" placeholder="按用户名检索">
                        ...
                        <div class="DTTT_container">
                            <table id="example" class="table table-striped responsive-utilities jambo_table dataTable"
                                ...
                                <tr class="headings" role="row">
                                    ...
                                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                        rowspan="1"
                                        colspan="1" aria-label="Invoice Date : activate to sort column ascending"
                                        style="">邮箱
                                    </th>
                                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                        rowspan="1"
                                    ...
                                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                        rowspan="1"
                                        colspan="1" aria-label="Bill to Name : activate to sort column ascending"
                                        style="">操作
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <?php foreach ($data as $value): ?>
                                    <tr class="pointer odd">
                                        ...
                                        <td class=" "><?php echo date('Y-m-d H:i:s',$value->create_time) ?></td>
                                        <td class=" ">
                                            <a href="<?= \yii\helpers\Url::to(['save','id'=>$value->id]) ?>" class="btn btn-primary btn-sm">编辑</a>
                                            <a href="<?= \yii\helpers\Url::to(['delete','id'=>$value->id]) ?>" class="btn btn-success btn-sm">删除</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
