...
class AlipayPay {
    ...
    public $partner = '2088312338545248';
    /**
     * @var String 收款支付宝账号
     */
    public $seller_email = '2036999602@qq.com';
    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = '8e1c7m85zppbgkvj9bsfkp3oewxzwyvn';
    //↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    /**
     ...
     */
    public $notify_url = 'http://yii2.cntxb.com/notify.php';
    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'http://yii2.cntxb.com/pay/return';
