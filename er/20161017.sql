...
CREATE TABLE `shop_address` (
  ...
  `last_name` varchar(32) NOT NULL DEFAULT '' COMMENT '名  字符串拼接',
...
insert  into `shop_address`(`address_id`,`first_name`,`last_name`,`company`,`address`,`post_code`,`email`,`telephone`,`user_id`,`create_time`) values (1,'张','三','','深圳宝安区固戍街道','','2036999602@qq.com','18819069937',19,0),(6,'王','五','记忆科技有限公司','深圳宝安区固戍街道','518000','2036999602@qq.com','18819069937',19,1476019310),(9,'fsadfsa','fsafsaf','fsafsaf','深圳宝安区固戍街道','518000','2036999602@qq.com','18819069937',19,1476090776),(10,'fsaf','fsaf','fsaf','fsaffsafsa','518000','fsaf','fsaf',19,1476091152),(11,'张','五','fsafsaf','深圳宝安区固戍街道','518000','2036999602@qq.com','18819069937',58,1476277789),(12,'张','五','记忆科技有限公司','深圳宝安区固戍街道','518000','2036999602@qq.com','18819069937',62,1476512099);
...
insert  into `shop_admin`(`id`,`username`,`password`,`email`,`login_time`,`login_ip`,`create_time`) values (2,'test','c4ca4238a0b923820dcc509a6f75849b','rickshop@163.com',0,0,0),(35,'admin','e10adc3949ba59abbe56e057f20f883e','',1476677097,2130706433,1476210985),(36,'admin999','00ba7ceab606427071d5d755ea99e976','rickshopsss@163.com',0,0,1476357436);
...
CREATE TABLE `shop_goods` (
  ...
  `pics` text COMMENT '商品多图 多张json存储（七牛）',
...
CREATE TABLE `shop_member` (
  ...
  `username` varchar(100) NOT NULL DEFAULT '' COMMENT '手机号码',
...
/*Table structure for table `shop_member_phone` */

DROP TABLE IF EXISTS `shop_member_phone`;

CREATE TABLE `shop_member_phone` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `shop_member_phone` */

insert  into `shop_member_phone`(`id`,`phone`,`password`,`create_time`) values (1,'18819069937','e10adc3949ba59abbe56e057f20f883e',1476637775),(2,'18819069937','e10adc3949ba59abbe56e057f20f883e',1476637808),(3,'18819069937','e10adc3949ba59abbe56e057f20f883e',1476638268),(4,'18565633970','e10adc3949ba59abbe56e057f20f883e',1476639144);
...
CREATE TABLE `shop_order` (
  ...
  `status` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单状态  0订单初始化 100待支付 201 支付失败 202等待发货 220已发货 260订单完成',
  `express_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '快递id',
  `express_no` varchar(50) NOT NULL DEFAULT '' COMMENT '快递编号',
  `trade_no` varchar(100) NOT NULL DEFAULT '' COMMENT '支付宝交易号',
  `tradeext` text COMMENT '支付宝返回数据',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
insert  into `shop_order`(`order_id`,`user_id`,`address_id`,`amount`,`status`,`express_id`,`express_no`,`trade_no`,`tradeext`,`create_time`,`update_time`) values (93,18,7,'2714.00',100,1,'','',NULL,1476061790,'2016-10-10 09:11:29'),(94,18,0,'0.00',0,0,'','',NULL,1476063192,'2016-10-10 09:33:12'),(95,19,0,'0.00',0,0,'','',NULL,1476090027,'2016-10-10 17:00:27'),(96,19,0,'0.00',0,0,'','',NULL,1476091382,'2016-10-10 17:23:02'),(97,19,1,'5418.00',100,2,'','',NULL,1476204092,'2016-10-12 00:41:38'),(98,19,1,'1.00',100,3,'','',NULL,1476267077,'2016-10-17 19:15:43'),(99,58,0,'0.00',0,0,'','',NULL,1476277613,'2016-10-12 21:06:53'),(102,58,0,'0.00',0,0,'','',NULL,1476277710,'2016-10-12 21:08:30'),(103,58,11,'13515.00',100,2,'','',NULL,1476277758,'2016-10-12 21:09:55'),(104,19,1,'8919.00',100,2,'','',NULL,1476329040,'2016-10-13 11:24:04'),(105,19,0,'0.00',0,0,'','',NULL,1476332171,'2016-10-13 12:16:11'),(106,19,0,'0.00',0,0,'','',NULL,1476333944,'2016-10-13 12:45:44'),(107,62,0,'0.00',0,0,'','',NULL,1476334244,'2016-10-13 12:50:44'),(108,62,0,'0.00',0,0,'','',NULL,1476334400,'2016-10-13 12:53:20'),(109,62,0,'0.00',0,0,'','',NULL,1476334616,'2016-10-13 12:56:56'),(110,19,0,'0.00',0,0,'','',NULL,1476334760,'2016-10-13 12:59:20'),(112,62,0,'0.00',0,0,'','',NULL,1476334847,'2016-10-13 13:00:47'),(113,62,0,'0.00',0,0,'','',NULL,1476334908,'2016-10-13 13:01:48'),(114,62,12,'220.00',100,2,'','',NULL,1476335110,'2016-10-13 13:08:59'),(115,62,12,'1.00',100,3,'','',NULL,1476335550,'2016-10-13 14:40:14'),(116,62,12,'5418.00',100,2,'','',NULL,1476367808,'2016-10-13 22:10:11'),(117,62,0,'0.00',0,0,'','',NULL,1476413790,'2016-10-14 10:56:30'),(118,62,12,'2719.00',100,2,'','',NULL,1476413951,'2016-10-14 10:59:19'),(119,62,0,'0.00',0,0,'','',NULL,1476456771,'2016-10-14 22:52:51'),(120,62,0,'0.00',0,0,'','',NULL,1476456865,'2016-10-14 22:54:25'),(121,19,1,'2720.00',220,2,'667356036694','',NULL,1476495408,'2016-10-17 22:44:50'),(122,19,1,'1.00',100,3,'','',NULL,1476510743,'2016-10-17 19:33:26'),(125,19,1,'1.00',260,3,'','',NULL,1476511076,'2016-10-17 18:40:26'),(126,62,12,'1.00',100,3,'','',NULL,1476512084,'2016-10-15 14:17:08'),(127,62,12,'21.00',100,2,'','',NULL,1476514227,'2016-10-15 14:54:53'),(128,62,12,'2.00',0,2,'','',NULL,1476515402,'2016-10-17 15:46:19'),(129,62,12,'1.00',100,3,'','',NULL,1476515725,'2016-10-15 15:17:00'),(131,62,12,'1.00',100,3,'','',NULL,1476517520,'2016-10-15 15:45:24'),(132,62,12,'1.00',100,3,'','',NULL,1476518141,'2016-10-15 15:55:47'),(133,62,12,'1.00',100,3,'','',NULL,1476518230,'2016-10-15 15:57:29'),(134,62,12,'1.00',100,3,'','',NULL,1476518598,'2016-10-15 16:03:24'),(135,62,12,'1.00',100,3,'','',NULL,1476518838,'2016-10-15
1,125,1476511076),(125,5,'1.00',1,126,1476512084),(126,5,'1.00',1,127,1476514227),(127,3,'200.00',1,128,1476515402),(128,4,'1.00',1,129,1476515725),(129,2,'2699.00',6,128,1476515935),(130,5,'1.00',1,131,1476517520),(131,4,'1.00',1,132,1476518141),(132,5,'1.00',1,133,1476518230),(133,5,'1.00',1,134,1476518598),(134,5,'1.00',1,135,1476518838),(135,5,'0.01',1,136,1476519091),(136,5,'0.01',1,137,1476519175),(137,50,'0.01',1,138,1476677081),(138,6,'0.00',1,140,1476693287),(139,6,'0.00',1,141,1476704941),(140,2,'2699.00',1,142,1476713997);
...
CREATE TABLE `shop_phone` (
  ...
  `code` int(6) NOT NULL DEFAULT '0' COMMENT '手机验证码',
  `deadline` varchar(20) NOT NULL DEFAULT '0' COMMENT '验证码有效期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

/*Data for the table `shop_phone` */

insert  into `shop_phone`(`id`,`phone`,`code`,`deadline`) values (16,'18819069937',356489,'2016-10-17 02:03:53'),(17,'18565633970',177796,'2016-10-17 02:24:41');
...
CREATE TABLE `shop_users` (
  ...
  `email` varchar(100) NOT NULL DEFAULT '' COMMENT '邮箱',
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `open_id` char(32) NOT NULL DEFAULT '0' COMMENT 'qq登陆id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='会员表';

/*Data for the table `shop_users` */

insert  into `shop_users`(`id`,`username`,`password`,`email`,`create_time`,`open_id`) values (19,'admin','e10adc3949ba59abbe56e057f20f883e','2036999602ff@qq.com',0,'0'),(41,'test_57fd37cca7a49','d3e1b99c46053dfa9d6ec3c8fcc25561','2036999602@qq.com',0,'0'),(45,'test_57fd3a3ce0d05','d41d8cd98f00b204e9800998ecf8427e','18819069937@163.com',0,'0'),(46,'','d41d8cd98f00b204e9800998ecf8427e','',0,'0'),(48,'hfdh','123456','',0,'0'),(49,'admin123','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(50,'admin123456','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(51,'a1','1','',0,'0'),(55,'a3','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(56,'admin666','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(57,'admin999','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(58,'admin888','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(62,'admin6','e10adc3949ba59abbe56e057f20f883e','',0,'DCCDC68FD4420636894DC13A56464969'),(63,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(64,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(65,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(66,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(67,'admin','e10adc3949ba59abbe56e057f20f883e','',0,'0'),(68,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0'),(69,'admin','c4ca4238a0b923820dcc509a6f75849b','',0,'0');
